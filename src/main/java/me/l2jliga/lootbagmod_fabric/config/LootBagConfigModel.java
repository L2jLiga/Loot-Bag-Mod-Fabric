...
public class LootBagConfigModel {
    ...
    @RestartRequired
    public List<String> Namespaces = new ArrayList<>(List.of(
            "lootbagmod"
    ));
    ...
    @RestartRequired
    public List<String> ContainsList = new ArrayList<>(List.of(
            "apples",
            "creative"
    ));
    ...
    @RestartRequired
    public List<String> ChestsLists = new ArrayList<>(List.of(
